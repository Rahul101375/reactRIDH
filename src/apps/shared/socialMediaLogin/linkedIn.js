...
export default function LinkedInLoginComponent() {
    ...
    const onResolve = async ({ provider, data }) => {
      try {
        ...
        const response = await axios.post('https://oauth2.googleapis.com/token', {
          ...
          client_id: environment?.linkedInAppId,
          client_secret: environment?.linkedInAppSecret, // Replace with your client secret
